    ...
    <div class="content contenido">
        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <button  type = "submit" class="btn btn-primary btn-round btn-lg btn-block mb-3">{{ __('Ingreso') }}</button>
                <div class="pull-left">
                    <h6>
                ...
                <div class="pull-right">
                    <h6>
                    <a href="{{ route('password.request') }}" class="link footer-link">{{ __('¿Olvidó Contraseña?') }}</a>
                    </h6>                
                </div>
                </div>
            </div>
